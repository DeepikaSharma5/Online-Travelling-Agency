...
<link rel="stylesheet" href="reviews1.css" media="all">
...
<div class="header">
  <div class="shell">
    ...
    <div class="page">
      <div class="review">
        <h1 class="re">Reviews</h1><br><br><br>
			<img src="profile1.jpeg" alt="image1" width="100px" height="100px">
			<p><strong>This is a very nice website. Easy to book trips, tours and very cost effective.
				Good communication with the admin. Happy :) </p>
				<br><br>
			<img src="profile2.jpg" alt="image2" width="100px" height="100px">
			<p>Good website. Easy to book trips. Good locations. Will travel with them again.</p>
				<br><br>
			<img src="profile3.jpg" alt="image3" width="100px" height="100px">
			<p>Good communication and Nice location and facilities provided by the agency is very well..... Enjoyed a lot.will visit again and again....</strong></p>
				<br></br>
			...
			<input type="text" name="Email" id="Email"  placeholder="Your given email address..." required>
			<br>
			<strong>Title :</strong>
			...
			<input type="text" name="Comment" id="Comment" placeholder="Write your review..." required>
			<br>
