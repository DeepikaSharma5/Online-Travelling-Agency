    ...
    <div class="page">
      <div class="review">
        <h1 class="re">Reviews</h1><br><br>
			<img src="profile7.jpg" alt="image1" width="100px" height="100px">
			<p><strong>Had happy days with this travel agency. Good food and place to stay. Tasty food, Recomend this agency. </p>
				<br><br>
			<img src="profile8.jpg" alt="image2" width="100px" height="100px">
			<p>Good website. Easy to book trips. Good locations. Will travel with them again.</p>
				<br><br>
			<img src="profile9.jpg" alt="image3" width="100px" height="100px">
			<p>Good loctions.But food can be more better. Activites done by this agency is unforgatable. Will visit to srilanka with 
			this agency again</strong></p>
				<br></br>
			
      </div>
			<form method="post" action="review3.php">
			<div class="comment">
			...
			<input id="comment"type="text" name="comment" placeholder="Write your review..." required>
			<br>
